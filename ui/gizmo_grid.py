...
class DBIM_GGT_grid_endpoints(bpy.types.GizmoGroup):
    bl_idname = "DBIM_GGT_grid_endpoints"
    bl_label = "Grid Endpoints"
    ...
    def setup(self, context):
        def get_p1():
            ...
            if obj and getattr(obj, "is_IfcGridAxis", False):
        ...
        m1.icon = 'VIEWZOOM'  # just a placeholder icon, or use 'LAYER_ACTIVE'
